...
const Button = ({
  ...
  const buttonColor = !outline ? `bg-${variant} hover:bg-white` : `bg-white hover:bg-${variant}`
  const buttonText = !outline ? `text-white hover:text-${variant}` : `text-${variant} hover:text-white`
